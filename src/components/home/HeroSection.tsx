...
export const HeroSection: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center bg-white dark:bg-neutral-900">
      {/* Background gradient */}
          ...
          >
            <div className="relative mx-auto w-full max-w-md aspect-square">
              ...
              <svg
                ...
                className="w-full h-auto text-primary-500 dark:text-primary-400 opacity-80 dark:opacity-60"
              >
              ...
              {/* Animated basketball */}
              <motion.div
                className="absolute top-[calc(50%-20px)] left-[calc(50%-20px)] w-10 h-10 bg-primary-500 dark:bg-primary-400 rounded-full shadow-lg"
                animate={{
      ...
      <div className="absolute bottom-0 left-0 w-full overflow-hidden">
        ...
        >
          <path
            ...
            fill="currentColor"
            className="text-neutral-50 dark:text-neutral-800 opacity-50"
          />
          <path
            d="M0,0V15.81C13,36.92,27.64,56.86,47.69,72.05,99.41,111.27,165,111,224.58,91.58c31.15-10.15,60.09-26.07,89.67-39.8,40.92-19,84.73-46,130.83-49.67,36.26-2.85,70.9,9.42,98.6,31.56,31.77,25.39,62.32,62,103.63,73,40.44,10.79,81.35-6.69,119.13-24.28s75.16-39,116.92-43.05c59.73-5.85,113.28,22.88,168.9,38.84,30.2,8.66,59,6.17,87.09-7.5,22.43-10.89,48-26.93,60.65-49.24V0Z"
            fill="currentColor"
            className="text-neutral-100 dark:text-neutral-850 opacity-30"
          />
        </svg>
      </div>
    </div>
